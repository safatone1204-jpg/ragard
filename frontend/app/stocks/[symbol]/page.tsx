...
import RegardScoreWarning from '@/components/RegardScoreWarning'
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          ...
          <div className="flex flex-col items-center md:items-end">
            {profile.ragard_score !== null && (
              <div className="flex items-start gap-2 -mt-10 md:-mt-12">
                <div className="w-48 h-48">
                  <RagardScoreGauge score={profile.ragard_score} size="lg" />
                </div>
                <div className="pt-2">
                  <RegardScoreWarning 
                    dataCompleteness={profile.regard_data_completeness}
                    missingFactors={profile.regard_missing_factors}
                  />
                </div>
              </div>
            )}
        ...
        {profile.ai_overview && (
          <div className="mt-6 pt-6 border-t border-slate-800">
            ...
            <div className="space-y-6">
              {/* Regard Score Explanation - Most Important */}
              {profile.ai_overview.regard_score_explanation && (
                <div>
                  <h4 className="text-sm font-semibold text-ragard-textPrimary mb-2">How the Regard Score Was Calculated</h4>
              ...
              {/* Recent Catalysts */}
              {profile.ai_overview.recent_catalysts && (
                <div>
                  <h4 className="text-sm font-semibold text-ragard-textPrimary mb-2">Recent Catalysts</h4>
                  <p className="text-sm text-ragard-textSecondary leading-relaxed">
                    {profile.ai_overview.recent_catalysts}
                  </p>
                </div>
              ...
              {/* Market Context */}
              {profile.ai_overview.market_context && (
                <div>
                  <h4 className="text-sm font-semibold text-ragard-textPrimary mb-2">Market Context</h4>
                  <p className="text-sm text-ragard-textSecondary leading-relaxed">
                    {profile.ai_overview.market_context}
                  </p>
                </div>
              ...
              {/* Financial Snapshot */}
              {profile.ai_overview.financial_snapshot && (
                <div>
                  <h4 className="text-sm font-semibold text-ragard-textPrimary mb-2">Financial Health</h4>
                  <p className="text-sm text-ragard-textSecondary leading-relaxed">
                    {profile.ai_overview.financial_snapshot}
                  </p>
                </div>
              ...
              {/* Trading Context */}
              {profile.ai_overview.trading_context && (
                <div>
                  <h4 className="text-sm font-semibold text-ragard-textPrimary mb-2">Trading Context</h4>
                  <p className="text-sm text-ragard-textSecondary leading-relaxed">
                    {profile.ai_overview.trading_context}
                  </p>
                </div>
              ...
              {(profile.ai_overview.risk_label || profile.ai_overview.timeframe_hint) && (
                <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-slate-800">
                  {profile.ai_overview.risk_label && (
                    <span
                      className={`px-3 py-1.5 rounded-md text-xs font-semibold border ${
                        profile.ai_overview.risk_label === 'high'
                          ? 'bg-ragard-danger/20 text-ragard-danger border-ragard-danger/40'
                          : profile.ai_overview.risk_label === 'medium'
                          ? 'bg-yellow-500/20 text-yellow-500 border-yellow-500/40'
                          : 'bg-ragard-success/20 text-ragard-success border-ragard-success/40'
                      }`}
                    >
                  ...
                  {profile.ai_overview.timeframe_hint && (
                    <span className="px-3 py-1.5 rounded-md text-xs font-semibold bg-ragard-surfaceAlt border border-slate-700 text-ragard-textPrimary">
                      {profile.ai_overview.timeframe_hint
                        .split(' ')
